        ...
        <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    ...
                    {/* Right side - specific project name */}
                   <div className="flex items-center gap-2 ml-4 flex-shrink-0">
                        <span className="text-sm text-gray-600 whitespace-nowrap hidden sm:inline">Dự án:</span>
                        <input
                            type="text"
                            className="text-sm font-semibold text-gray-800 border-b border-transparent hover:border-gray-300 focus:border-blue-500 focus:outline-none bg-transparent px-1 transition-colors w-24 sm:w-32 md:w-48 lg:w-80 text-right sm:text-left"
